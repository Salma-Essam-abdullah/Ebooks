   ...
   <body class="main-layout contact-page">
      ...
      <div class="Contact">
         <div class="container">
            <div class="row">
               <div class= "col-md-4">
                <img src="<?php echo e(asset('/storage/'.$books->image)); ?>" class="card-text" alt="Image">
               </div>
...
<?php /**PATH C:\Users\SALMA\example-app2\resources\views/books/show.blade.php ENDPATH**/ ?>
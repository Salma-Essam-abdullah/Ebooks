               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        ...
                        <div class="button_section"> <a class="main_bt" href="<?php echo e(route('list.booklist')); ?>">Read More</a>  </div>
                        <ul class="locat_icon">
            ...
            <div class="row border">
               <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12">
                  <div class="about-box">
                     ...
                     <a href="<?php echo e(route('books.about')); ?>">Read More</a>
                  </div>
               </div>
      ...
      <div class="Library">
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="read-more">
                     <a href=<?php echo e(route('list.booklist')); ?>>Read More</a>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <div class="read-more">
                        <a href="<?php echo e(route('books.index')); ?>">Read More</a>
                     </div>
                  </div>
               </div>
            </div>
...
<?php /**PATH C:\Users\SALMA\example-app2\resources\views/home.blade.php ENDPATH**/ ?>
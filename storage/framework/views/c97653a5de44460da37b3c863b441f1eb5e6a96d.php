                     ...
                     <div class="books">
                          <div class="card">
                            <div class="container">
                                ...
                                <p><?php echo e($books->id); ?></p>
                            <img src="<?php echo e($books->image); ?>"/>
                             <h4><b><?php echo e($books->name); ?></b></h4>
                              <p><?php echo e($books->description); ?></p>
                              <p><?php echo e($books->price); ?></p>
                              <p><?php echo e($books->quantity); ?></p>
                              <a href="<?php echo e(route('books.show', ['books'=>$books->id])); ?>" type="button" class="send-btn" >Show</a>
...
<?php /**PATH C:\Users\SALMA\example-app2\resources\views/index.blade.php ENDPATH**/ ?>